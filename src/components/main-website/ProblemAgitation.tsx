      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="space-y-6 text-lg text-gray-700 leading-relaxed mb-10">
          ...
          <p className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm font-medium">
            Olyan marketing felületeket építünk neked, amelyek a <span className="text-brand-accent font-bold">látogatói pszichológiát</span> használják a meggyőzésre. Megszüntetjük a találgatást, és <span className="font-bold text-brand-900">tűpontos adatokkal</span> tesszük egyértelművé, miért éppen nálad kell elkölteniük a pénzüket.
          </p>
        </div>
