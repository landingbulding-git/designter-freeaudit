...
export default function Hero({ clientName, companyName, heroImage }: { clientName: string, companyName: string, heroImage?: string | null }) {
  const bgImage = heroImage || "https://imgproxy.gamma.app/resize/quality:80/resizing_type:fit/width:1200/https://cdn.gamma.app/f7qbj53x16le5jb/354e7c28c416479d9046c894a738492c/original/Screenshot-2026-03-16-at-18.38.38.png";
