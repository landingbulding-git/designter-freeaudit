    ...
    <section className="bg-[#1e293b] rounded-[2rem] p-10 md:p-16 shadow-[0_0.5rem_0_0_#ea580c] space-y-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="text-center space-y-1">
          <p className="text-[3em] font-extrabold text-white leading-none font-heading mb-3">{stats.visitors}</p>
        ...
        <div className="text-center space-y-1">
          <p className="text-[3em] font-extrabold text-white leading-none font-heading mb-3">{stats.conversionRate}%</p>
        ...
        <div className="text-center space-y-1">
          <p className="text-[3em] font-extrabold text-white leading-none font-heading mb-3">{stats.avgOrderValue} Ft</p>
        ...
        <div className="text-center space-y-1">
          <p className="text-[3em] font-extrabold text-white leading-none font-heading mb-3">{stats.adSpend / 1000}K Ft</p>
      ...
      <div className="space-y-8 pt-4">
        <h3 className="text-4xl md:text-[2.3rem] font-extrabold text-[#ea580c] leading-[1.3] font-heading">
        ...
        <p className="text-2xl md:text-[1.75rem] font-extrabold text-white leading-[1.4] font-heading">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-6">
        {stats.projections.map((proj, idx) => (
          <div key={idx} className="text-center space-y-1">
            <p className="text-[3em] font-extrabold text-white leading-none font-heading mb-3">{proj.increase}</p>
      ...
      <div className="pt-8 pb-4 text-center">
        <h2 className="text-6xl md:text-8xl lg:text-[6.3rem] font-extrabold text-[#ea580c] leading-[1.1] font-heading">
          {stats.projections[0].increase}-nál {stats.roi} megtérülésed van.
        </h2>
      </div>

      <div className="text-center pt-4">
        <a href="#pricing" className="inline-block bg-[#ea580c] hover:bg-[#d03e00] text-white font-semibold py-4 px-10 rounded-md transition-colors text-xl">
