...
export default function Stats({ stats, slug, linkHref }: StatsProps & { slug?: string; linkHref?: string }) {
  return (
    <section className="bg-[#1e293b] rounded-[2rem] p-8 md:p-16 shadow-[0_0.5rem_0_0_#ea580c] space-y-16 text-center md:text-left">
      ...
      <div className="text-center md:text-left pt-4">
        <a href={linkHref || `/contract/${slug}`} className="inline-block w-full md:w-auto bg-[#ea580c] hover:bg-[#d03e00] !text-white font-semibold py-4 px-10 rounded-md transition-colors text-xl">
